...
var RestModel = (function (_super) {
    ...
    RestModel.define = function (protoProps, staticProps) {
        var staticsDefinition = tools.getChangedStatics(this, 'urlRoot'), definition = tools.assign(staticsDefinition, protoProps);
